                            ...
                            <div class="col-md-6">
                                ...
                                <form action="/AliaksandrHaurylenka/project/store" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="type_project" name="type_project" value="<?= $project['type_project']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="technology" class="form-control" id="technology"><?= $project['technology']; ?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="link_site" name="link_site" value="<?= $project['link_site']; ?>">
                                    </div>
